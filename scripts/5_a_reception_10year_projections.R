...
bootstrapped_output_filename <- paste0("output_projections/intermediate_outputs/reception_full_bootstrapped_", max_year, "_", max_year + 9, ".rds")

saveRDS(object = bootstrapped_reception_intervals,
        file = bootstrapped_output_filename)

  ### the bootstrapped input time series
bootstrapped_births_filename <- paste0("output_projections/intermediate_outputs/reception_bootstrapped_births_", max_year, "_", max_year + 9, ".rds")

saveRDS(object = final_births_resamples,
        file = bootstrapped_births_filename)

bootstrapped_ratio_filename <- paste0("output_projections/intermediate_outputs/reception_bootstrapped_ratio_", max_year, "_", max_year + 9, ".rds")
...
bootstrapped_births_forecast_filename <- paste0("output_projections/intermediate_outputs/reception_bootstrapped_births_forecast_", max_year, "_", max_year + 9, ".rds")

saveRDS(object = births_bootstrapped_forecasts,
        file = bootstrapped_births_forecast_filename)

bootstrapped_ratio_forecast_filename <- paste0("output_projections/intermediate_outputs/reception_bootstrapped_ratio_forecast_", max_year, "_", max_year + 9, ".rds")
...
births_projections_filename <- paste0("output_projections/intermediate_outputs/reception_births_central_", max_year, "_", max_year + 9, ".rds")

saveRDS(object = projected_births,
        file = births_projections_filename)

ratio_projections_filename <- paste0("output_projections/intermediate_outputs/reception_ratio_central_", max_year, "_", max_year + 9, ".rds")
