...
for (geog in unique_geogs) {
  ...
  #### making the plot
  png(
    file = paste0("plots/", max_year, "_", max_year + 9, "/reception_tenyear/", geog_name, ".png"),
...
png(
  file = paste0("plots/", max_year, "_", max_year + 9, "/all_years_tenyear_forecast/reception_tenyear.png"),
